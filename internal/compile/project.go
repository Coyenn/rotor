...
// ProjectOptions is the subset of upstream ProjectOptions (Shared/types.ts)
// rotor's library entry points accept. The zero value reproduces
// DEFAULT_PROJECT_OPTIONS for every supported field.
...
// CompileProjectWithOptions is CompileProject with explicit ProjectOptions
// (currently the --type ProjectType override); the zero options value is
// exactly CompileProject.
