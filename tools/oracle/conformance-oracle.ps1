...
# Requires Node/npm (mise-managed). Run from repo root:
...
Push-Location $proj
# node is mise-managed; npx may be absent — invoke the local bin shim directly.
...
.\node_modules\.bin\rbxtsc.cmd --type model --allowCommentDirectives
